package common.utils.view.animation;
 ...
 * Description 擦除当前页面的动画效果，支持5.0以上。主题切换动画效果
 * <p>
 * 使用方法 RippleAnimation.create(view).setDuration(200).start();
 * <p>
 * https://github.com/wuyr/RippleAnimation/blob/master/app/src/main/java/com/wuyr/rippleview/RippleAnimation.java
 */
