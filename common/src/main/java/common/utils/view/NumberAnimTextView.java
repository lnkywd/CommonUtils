...
public class NumberAnimTextView extends AppCompatTextView {
    ...
    public void setNumberString(String numberStart, String numberEnd) {
        ...
        if (checkNumString(numberStart, numberEnd)) {
            ...
            setText(String.format("%s%s%s", mPrefixString, numberEnd, mPostfixString));
        }
    }
    ...
    private void start() {
        if (!isEnableAnim) {
            // 禁止动画
            setText(String.format("%s%s%s", mPrefixString, format(new BigDecimal(mNumEnd)), mPostfixString));
            return;
        }
        ...
        animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                ...
                setText(String.format("%s%s%s", mPrefixString, format(value), mPostfixString));
            }
        });
        animator.start();
    }
