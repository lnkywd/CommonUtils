package common.utils.view.loadingview;
 ...
 * Description 仿抖音v2.5  加载框 https://github.com/CCY0122/douyinloadingview/blob/master/src/main/java/com/douyinloadingview/DYLoadingView.java
 */
...
public class DYLoadingView extends View {
    ...
    public DYLoadingView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.wd_DYLoadingView);
        radius1 = ta.getDimension(R.styleable.wd_DYLoadingView_radius1, RADIUS);
        radius2 = ta.getDimension(R.styleable.wd_DYLoadingView_radius2, RADIUS);
        gap = ta.getDimension(R.styleable.wd_DYLoadingView_gap, GAP);
        rtlScale = ta.getFloat(R.styleable.wd_DYLoadingView_rtlScale, RTL_SCALE);
        ltrScale = ta.getFloat(R.styleable.wd_DYLoadingView_ltrScale, LTR_SCALR);
        color1 = ta.getColor(R.styleable.wd_DYLoadingView_color1, LEFT_COLOR);
        color2 = ta.getColor(R.styleable.wd_DYLoadingView_color2, RIGHT_COLOR);
        mixColor = ta.getColor(R.styleable.wd_DYLoadingView_mixColor, MIX_COLOR);
        duration = ta.getInt(R.styleable.wd_DYLoadingView_duration, DURATION);
        pauseDuration = ta.getInt(R.styleable.wd_DYLoadingView_pauseDuration, PAUSE_DUARTION);
        scaleStartFraction = ta.getFloat(R.styleable.wd_DYLoadingView_scaleStartFraction, SCALE_START_FRACTION);
        scaleEndFraction = ta.getFloat(R.styleable.wd_DYLoadingView_scaleEndFraction, SCALE_END_FRACTION);
        ta.recycle();
