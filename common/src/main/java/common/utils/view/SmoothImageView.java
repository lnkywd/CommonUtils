 ...
 * Description 动画效果的 imageview
 * 需要记录点击按钮的 Rect ，将 rect 传过来，调 setThumbRect
 * https://github.com/yangchaojiang/ZoomPreviewPicture/blob/master/ImagePreview/src/main/java/com/previewlibrary/wight/SmoothImageView.java
 */
...
public class SmoothImageView extends PhotoView {
    ...
    private void initTransform() {
        ...
        startTransform.top = thumbRect.top - BarUtils.getStatusBarHeight();
